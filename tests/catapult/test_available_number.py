...
class AvailableNumberTests(unittest.TestCase):
    def test_search_available_local_numbers(self):
        ...
        with patch('requests.request', return_value = create_response(200, estimated_json)) as p:
            ...
            p.assert_called_with('get','https://api.catapult.inetwork.com/v1/availableNumbers/local', auth=AUTH, params=estimated_json_request)
    ...
    def test_search_available_toll_free_numbers(self):
        ...
        with patch('requests.request', return_value = create_response(200, estimated_json)) as p:
            ...
            p.assert_called_with('get','https://api.catapult.inetwork.com/v1/availableNumbers/tollFree', auth=AUTH, params=estimated_json_request)
    ...
    def test_search_and_order_local_numbers(self):
        ...
        with patch('requests.request', return_value = create_response(200, estimated_json)) as p:
            ...
            p.assert_called_with('post','https://api.catapult.inetwork.com/v1/availableNumbers/local', auth=AUTH, params=estimated_json_request)
    ...
    def test_search_and_order_toll_free_numbers(self):
        ...
        with patch('requests.request', return_value = create_response(200, estimated_json)) as p:
            ...
            p.assert_called_with('post','https://api.catapult.inetwork.com/v1/availableNumbers/tollFree', auth=AUTH, params=estimated_json_request)
            self.assertEqual('{national_number1}', data[0]['nationalNumber'])
            self.assertEqual('{numberId1}', data[0]['id'])