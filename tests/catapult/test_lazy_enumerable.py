...
class LazyEnumerableTests(unittest.TestCase):
    def test_get_lazy_enumerator(self):
        ...
        """
        with patch('requests.request', return_value=helpers.create_response(200, '[1, 2, 3]')) as p:
            ...
            p.assert_called_with('get', 'https://api.catapult.inetwork.com/v1/users/userId/account/transactions?page=0&size=25', auth=helpers.AUTH)
    ...
    def test_get_lazy_enumerator_with_several_requests(self):
        ...
        response1 = helpers.create_response(200, estimated_json1)
        ...
        response2 = helpers.create_response(200, estimated_json2)
        client = helpers.get_client()
        with patch('requests.request', return_value=response2) as p:
            ...
            p.assert_called_with('get', 'https://api.catapult.inetwork.com/v1/users/userId/account/transactions?page=1&size=25', auth=helpers.AUTH)
