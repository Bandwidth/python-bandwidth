...
class ApplicationTests(unittest.TestCase):
    def test_list_applications(self):
        ...
        with patch('requests.request', return_value = create_response(200, estimated_json)) as p:
            ...
            p.assert_called_with('get', 'https://api.catapult.inetwork.com/v1/users/userId/applications', auth=AUTH, params= { "size" : None })
    ...
    def test_create_application(self):
        ...
        with patch('requests.request', return_value = estimated_response) as p:
            ...
            p.assert_called_with('post', 'https://api.catapult.inetwork.com/v1/users/userId/applications', auth=AUTH, json=estimated_json_request)
